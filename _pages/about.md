...
Research Interests
-----------
Broadly my research interest is in [feature extraction](https://en.wikipedia.org/wiki/Feature_extraction) when we have additional geometric information we can exploit. 
